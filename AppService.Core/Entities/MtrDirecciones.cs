...
namespace AppService.Core.Entities
{
    ...
    {
        public MtrDirecciones()
        {
            AppGeneralQuotesIdDireccionEntregarNavigation = new HashSet<AppGeneralQuotes>();
            AppGeneralQuotesIdDireccionFacturarNavigation = new HashSet<AppGeneralQuotes>();
        }
        ...
        public virtual ICollection<AppGeneralQuotes> AppGeneralQuotesIdDireccionEntregarNavigation { get; set; }
        public virtual ICollection<AppGeneralQuotes> AppGeneralQuotesIdDireccionFacturarNavigation { get; set; }
    }
}
