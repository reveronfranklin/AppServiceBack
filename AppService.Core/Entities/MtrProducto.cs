...
namespace AppService.Core.Entities
{
    public partial class MtrProducto
    {
        public MtrProducto()
        {
            ...
            CatProductoMayorUnidadesConversion = new HashSet<CatProductoMayorUnidadesConversion>();
        ...
        public virtual ICollection<CatProductoMayorUnidadesConversion> CatProductoMayorUnidadesConversion { get; set; }
